...
export class TodoItemComponent extends HTMLElement {
    ...
    connectedCallback() {
        ...
        TodoListDataServices.AddTodoItem(
            this.id,
    ...
    saveContent(e) {
        ...
        TodoListDataServices.UpdateTodoItem(this.id, this.contentInput.value);
    }
    ...
    toggleChecked(e) {
        ...
        TodoListDataServices.CheckTodoItem(this.id, e.target.checked);
    }
    ...
    deleteTodoItem(e) {
        ...
        if (todoItem.parentNode && todoItem.parentNode.matches(".todo-items")) {
            TodoListDataServices.DeleteTodoItem(todoItem.id);
